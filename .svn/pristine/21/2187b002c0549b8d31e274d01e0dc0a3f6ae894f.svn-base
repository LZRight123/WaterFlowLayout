...
- (void)viewDidLoad {
    [super viewDidLoad];
    CoverLayout *cover = [[CoverLayout alloc]init];
    cover.itemSize = CGSizeMake(100, 200);
    self.collectionView.collectionViewLayout = cover;
//    WaterFlowLayout *flow = (WaterFlowLayout*)self.collectionView.collectionViewLayout;
//    flow.numberOfColumn = 3;
//    flow.interItemSpacing = 10;
